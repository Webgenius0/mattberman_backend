...
class InspectionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $inspection = Inspection::create([
            ...
            'satisfactory' => filter_var($request->input('satisfactory'), FILTER_VALIDATE_BOOLEAN),
            'corrected'    => filter_var($request->input('corrected'), FILTER_VALIDATE_BOOLEAN),
            'not_corrected'=> filter_var($request->input('not_corrected'), FILTER_VALIDATE_BOOLEAN),
    ...
    public function update(Request $request , $id)
    {
        ...
        $filePath = $signatureImage->move( public_path( 'upload/'), $file);
            ...
            $driver->satisfactory = filter_var($request->input('satisfactory'), FILTER_VALIDATE_BOOLEAN);
            $driver->corrected = filter_var($request->input('corrected'), FILTER_VALIDATE_BOOLEAN);
            $driver->not_corrected = filter_var($request->input('not_corrected'), FILTER_VALIDATE_BOOLEAN);
